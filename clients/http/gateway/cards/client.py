...
from clients.http.gateway.cards.schema import IssueVirtualCardRequestSchema, IssueVirtualCardResponseSchema, IssuePhysicalCardRequestSchema, IssuePhysicalCardResponseSchema
...
class CardsGatewayHTTPClient(HTTPClient):
    ...
    def issue_virtual_card(self, user_id: str, account_id: str) -> IssueVirtualCardResponseSchema:
        ...
        response = self.issue_virtual_card_api(request.model_dump(by_alias=True))
    ...
    def issue_physical_card(self, user_id: str, account_id: str) -> IssuePhysicalCardResponseSchema:
        ...
        response = self.issue_physical_card_api(request.model_dump(by_alias=True))
